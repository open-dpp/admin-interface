...
export const routes = [
    ...
    {path: '/products/:productId/qr-code', component: () => import('../view/products/ProductQrCode.vue')},
    {path: '/products/:productId', component: () => import('../view/products/Product.vue')},
    {path: '/notifications', component: () => import('../view/Notifications.vue')},
