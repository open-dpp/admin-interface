<template>
  <form-kit
      ...
      outer-class="w-full"
  >
    <form-kit name="stepper" type="multi-step" tab-style="tab" :allow-incomplete="false" :wrapper-class="{ 'w-full': true }">
      <form-kit type="step" name="generalInfo" label="Allgemein" :wrapper-class="{ 'w-full': true }">
        <form-kit
            type="text"
            label="Name"
            name="name"
