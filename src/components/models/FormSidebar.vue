              ...
              <DialogPanel class="pointer-events-auto w-screen max-w-md">
                ...
                >
                    ...
                    <div class="bg-indigo-700 px-4 py-6 sm:px-6">
                      <div class="flex items-center justify-between">
                        ...
                        <div class="ml-3 flex h-7 items-center">
                          <button
                            class="relative rounded-md bg-indigo-700 text-indigo-200 hover:text-white focus:outline-hidden focus:ring-2 focus:ring-white"
                            type="button"
                            @click="closeSidebar"
                          >
                  ...
                  <div class="flex shrink-0 justify-end px-4 py-4">
                    ...
                    <button
                      class="ml-4 inline-flex justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      type="submit"
                    >
                      Speichern
                    </button>
