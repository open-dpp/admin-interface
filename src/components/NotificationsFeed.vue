      ...
      <li v-for="(activityItem, activityItemIdx) in activity" :key="activityItem.id">
        <div class="relative pb-8">
          <span v-if="activityItemIdx !== activity.length - 1"
                aria-hidden="true" class="absolute left-5 top-5 -ml-px h-full w-0.5 bg-gray-200"/>
            ...
            <template v-if="activityItem.type === 'comment'">
              <div class="relative">
                ...
                <span class="absolute -bottom-0.5 -right-1 rounded-tl bg-white px-0.5 py-px">
                  <ChatBubbleLeftEllipsisIcon aria-hidden="true" class="h-5 w-5 text-gray-400"/>
                </span>
              </div>
                  ...
                  <span class="mr-0.5">
                    <template v-for="tag in activityItem.tags" :key="tag.name">
                      <a :href="tag.href"
                        ...
                        <svg :class="[tag.color, 'h-1.5 w-1.5']" aria-hidden="true" viewBox="0 0 6 6">
