<template>
  <section>
    ...
    <UpdateProduct  @success="onProductsChanged" :product-id="selectedProductId" v-model="showUpdateProduct" />
    <div class="flex flex-col gap-3 p-3">
      <ProductList v-if="productStore.products.length > 0" @add="showCreateProduct = true" @edit="onSelect"/>
