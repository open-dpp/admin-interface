...
ARG VITE_MARKETPLACE_ROOT="http://localhost:20007"
ENV VITE_MARKETPLACE_ROOT=$VITE_MARKETPLACE_ROOT
ARG VITE_AGENT_SERVER_ROOT="http://localhost:20007"
ENV VITE_AGENT_SERVER_ROOT=$VITE_AGENT_SERVER_ROOT
ARG VITE_MEDIA_SERVICE_ROOT="http://localhost:20007"
